...
// Extract services array from translations using the composable
const { getTranslationArray } = useTranslationArrays()
const services = computed(() => getTranslationArray('contact.info.services', [
