      ...
      <div class="container mx-auto px-6 lg:px-8">
        <div class="max-w-6xl mx-auto">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 class="text-4xl font-heading font-bold text-primary mb-8">{{ t('contact.info.title') }}</h2>
            ...
            <div class="bg-gray-50 rounded-lg p-8">
              <h3 class="text-2xl font-heading font-bold text-primary mb-6">{{ t('contact.details.title') }}</h3>
      ...
      <div class="container mx-auto px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
          <div class="text-center mb-12">
            <h2 class="text-4xl font-heading font-bold text-primary mb-6">{{ t('contact.form.title') }}</h2>
            ...
            <form @submit.prevent="handleSubmit" class="space-y-6">
              ...
              <div class="text-center">
                <button
                  ...
                  class="bg-primary hover:bg-primary-600 text-white px-8 py-4 font-heading font-semibold text-lg tracking-wide transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
